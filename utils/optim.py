"""
The following implementations are from flash:
- https://lightning-flash.readthedocs.io/en/latest/_modules/flash/core/optimizers/lars.html#LARS
- https://lightning-flash.readthedocs.io/en/latest/_modules/flash/core/optimizers/lr_scheduler.html#LinearWarmupCosineAnnealingLR

I copy paste instead of importing as lightning environments keep on changing. THose used to be in bolts but will now be
deleted.see: https://github.com/Lightning-AI/lightning-bolts/issues/839
"""
import math
import warnings
