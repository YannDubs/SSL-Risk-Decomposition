...
def get_mugs_models(name, architecture, representation="cls", is_train_transform=False):
    ...
    if is_train_transform:
        # MUGS has actually uses with 50% probability autoaugment and 50 % the one below.
